...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await db.schema
    ...
    .addColumn('tags', 'text')
    .addColumn('decision_due_at', 'timestamp')
  ...
  await db.schema
    ...
    .addColumn('tags', 'text')
    .addColumn('confidence', sql`decimal(3,2)`, (col) => col.notNull())
    .addColumn('confidence_factors', 'text')
    .addColumn('freshness_at', 'timestamp', (col) => col.notNull())
    .addColumn('citation', 'varchar(500)', (col) => col.notNull())
    .addColumn('attachment_urls', 'text')
  ...
  await db.schema
    ...
    .addColumn('relevance_score', sql`decimal(3,2)`, (col) => col.notNull().defaultTo(0))
    ...
    .addColumn('stance_confidence', sql`decimal(3,2)`, (col) => col.notNull().defaultTo(0))
  ...
  await db.schema
    ...
    .addColumn('confidence', sql`decimal(3,2)`, (col) => col.notNull())
    .addColumn('score', sql`decimal(5,2)`, (col) => col.notNull())
  ...
  await db.schema
    ...
    .addColumn('internal_analysis', 'text')
    .addColumn('external_analysis', 'text')
  ...
  await db.schema
    ...
    .addColumn('dissent', 'text')
    .addColumn('suggested_actions', 'text')
    .addColumn('evidence_summary', 'text')
    .addColumn('status', 'varchar(20)', (col) => col.notNull().defaultTo('draft'))
  ...
  await db.schema
    ...
    .addColumn('title', 'varchar(200)', (col) => col.notNull())
    .addColumn('description', 'text', (col) => col.notNull())
    .addColumn('evidence_ids', 'text')
    .addColumn('related_issue_ids', 'text')
  ...
  await db.schema
    ...
    .addColumn('error_log', 'text')
    .addColumn('imported_evidence_ids', 'text')
    .addColumn('started_at', 'timestamp')
    .addColumn('completed_at', 'timestamp')
    .addColumn('created_at', 'timestamp', (col) => col.notNull().defaultTo(sql`CURRENT_TIMESTAMP`))
    .addColumn('updated_at', 'timestamp', (col) => col.notNull().defaultTo(sql`CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP`))
